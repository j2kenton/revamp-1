      ...
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-lg">
        ...
        <div className="mt-8 space-y-6">
          ...
          <button
            onClick={handleLogin}
            disabled={isLoading}
            className="w-full flex cursor-pointer items-center justify-center gap-3 rounded-md bg-blue-600 px-4 py-3 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isLoading ? (
              <>
